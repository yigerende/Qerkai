export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        downstreamModelAlignment: 'Align OpenAI downstream model names',
        downstreamModelAlignmentHint: 'For selected groups and models, when the upstream response declares a different model, use the model actually sent upstream in client responses. Logs and quality checks retain the actual upstream model. Disabled preserves existing behavior.',
        downstreamModelAlignmentModels: 'Enabled models',
        downstreamModelAlignmentModelsHint: 'One model per line, matched against the model sent upstream. An empty list enables none. Supports HTTP/SSE and WebSocket; renaming does not change the answer or the model that ran.',
