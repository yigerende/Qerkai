              ...
              <div class="border-b border-gray-100 pb-5 dark:border-dark-700 md:col-span-2">
                ...
                >
                  ...
                  <option value="network">
                    {{ t("admin.settings.gatewayForwarding.openaiTTFTModeNetwork") }}
                  </option>
                </select>
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
              ...
              <div class="flex items-center justify-between">
                <div>
                  ...
                  >
                    {{
                      t(
                        "admin.settings.gatewayForwarding.forceOpenAIUpstreamWS",
                      )
                    }}
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{
                      t(
                        "admin.settings.gatewayForwarding.forceOpenAIUpstreamWSHint",
                      )
                    }}
                  </p>
                </div>
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      openai_ttft_mode:
        form.openai_ttft_mode === "visible" || form.openai_ttft_mode === "network"
          ? form.openai_ttft_mode
          : "semantic",
