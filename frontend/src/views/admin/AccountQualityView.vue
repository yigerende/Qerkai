...
const stats = [['total','定时检测账号'],['normal','答题正常'],['suspect','答题疑似异常'],['degraded','已确认异常'],['errors','答题失败'],['model_normal','模型一致'],['model_degraded','模型异常'],['model_state_pending','新 State 待验证'],['no_samples','模型无样本']]
...
.quality-page{max-width:1280px;margin:0 auto}.quality-stats{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));grid-auto-rows:minmax(90px,auto);gap:12px}.quality-stats article{border:1px solid #94a3b840;border-radius:6px;padding:14px;min-width:0}.quality-stats span{font-size:12px;overflow-wrap:anywhere}.quality-stats strong{display:block;font-size:24px;line-height:1.5}.quality-stats article:nth-child(2) strong,.quality-stats article:nth-child(6) strong{color:#059669}.quality-stats article:nth-child(4) strong,.quality-stats article:nth-child(7) strong{color:#dc2626}.quality-stats article:nth-child(8) strong{color:#d97706}.quality-tabs{display:flex;gap:24px;border-bottom:1px solid #94a3b840}.quality-tabs button{padding:12px 0;border-bottom:2px solid transparent}.quality-tabs .active{border-bottom-color:#059669}.quality-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:20px;padding:24px 0}.quality-grid label{display:flex;flex-direction:column;gap:8px;font-size:14px;min-width:0}.quality-grid .check{flex-direction:row;align-items:center}.quality-grid .wide{grid-column:1/-1}.quality-table{width:100%;min-width:600px;margin:16px 0}.quality-table th,.quality-table td{text-align:left;padding:10px 8px;border-bottom:1px solid #94a3b830}.quality-grid textarea{resize:vertical}@media(max-width:1024px){.quality-stats{grid-template-columns:repeat(3,minmax(0,1fr))}}@media(max-width:640px){.quality-grid{grid-template-columns:minmax(0,1fr)}.quality-stats{grid-template-columns:repeat(2,minmax(0,1fr));gap:6px}.quality-stats article{padding:8px}.quality-stats strong{font-size:20px}}
</style>
