...
var usageLogInsertArgTypes = [...]string{
	...
	"text",        // downstream_model
	"boolean",     // state_injected
	"integer",     // openai_upstream_5xx_retry_count
...
func prepareUsageLogInsert(log *service.UsageLog) usageLogInsertPrepared {
	...
	return usageLogInsertPrepared{
		...
		args: []any{
			...
			nullString(log.DownstreamModel),
			nullBool(log.StateInjected),
			nullInt(log.OpenAIUpstream5xxRetryCount),
