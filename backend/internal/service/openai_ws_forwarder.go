...
type OpenAIWSIngressHooks struct {
	...
	// RequestStarted observes accepted business turns before forwarding, including
	// attempts that fail. Reconnects can report the same turn more than once.
	RequestStarted func(turn int)
