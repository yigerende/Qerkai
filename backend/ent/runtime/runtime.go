...
func init() {
	...
	// usagelogDescDownstreamModel is the schema descriptor for downstream_model field.
	usagelogDescDownstreamModel := usagelogFields[9].Descriptor()
	// usagelog.DownstreamModelValidator is a validator for the "downstream_model" field. It is called by the builders before save.
	usagelog.DownstreamModelValidator = usagelogDescDownstreamModel.Validators[0].(func(string) error)
